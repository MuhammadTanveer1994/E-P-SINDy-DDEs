...
model = 'MG';        % Choose from: 'DL', 'MG','TDN', 'Rossler1','Rossler2', 'tau_3'
optimizer = 'BF';  % Choose from: 'none', 'PSO','BO', 'BF'
...
switch optimizer
    ...
    case 'PSO'
        if strcmp(model, 'MG')
        [bestTau, evalCount, elapsedTime, Theta_all, DX,bestpar3] = PSO(model, tau, par, DX_true, folderName);
        optimization_results.optimized_par3 = bestpar3;
        else
